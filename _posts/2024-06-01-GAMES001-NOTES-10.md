...
类似于曲线论基本定理，曲面论基本定理指出空间中曲面的形状可以由曲面的第一基本型和第二基本型来确定。但需要注意的是，曲面的第一基本型和第二基本型是存在一定的耦合关系的，即[Gauss-Codazzi方程](/2023/12/27/DifferentialGeometry-NOTES-05.html#gauss-codazzi方程)。
