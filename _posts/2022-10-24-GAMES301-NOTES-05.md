...
为了避免更新Hessian矩阵同时固定非零元结构，我们可以考虑每一对边界边可能出现的碰撞情况。此时先在Hessian矩阵相应的位置上填上0，这样Hessian矩阵的稀疏性会比较差。
...
在这种情况下求解稀疏线性系统的效率仍然比较低，甚至比直接更新Hessian矩阵并重复计算的情况还要差。
...
<div align=center>
<img src="https://i.imgur.com/JNWaDHF.png" width="80%">
</div>
...
<div align=center>
<img src="https://i.imgur.com/G3a5UmM.png" width="80%">
</div>

<div align=center>
<img src="https://i.imgur.com/0C9ZgOp.png" width="80%">
</div>
