...
<div align=center>
<img src="https://pbr-book.org/3ed-2018/Light_Sources/DistantLight%20approx%20power.svg" width="40%">
</div>
...
<div align=center>
<img src="https://pbr-book.org/3ed-2018/Light_Sources/area-scene-wide.png" width="60%">
</div>
...
由于只考虑法向半球上出射的光线，在计算`DiffuseAreaLight::L()`时需要考虑光线方向和法向的夹角，如果在负半球上则直接返回0。

<div align=center>
<img src="https://pbr-book.org/3ed-2018/Light_Sources/AreaLight%20multiple%20directions.svg" width="40%">
</div>

而`DiffuseAreaLight`发射的总能量可以通过公式来直接计算：
