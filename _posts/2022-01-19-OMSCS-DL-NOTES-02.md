...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/uzlx5J8.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/c0tK5gL.png" width="80%">
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/5Uc12vU.png" width="80%">
</div>

在计算机中，我们通过矩阵乘法来表示相互连接的神经元发射接收信号的过程。神经元接收信号并判断是否激活可以通过权重矩阵$W$和偏置向量$b$来描述。我们把神经元这样的计算封装成一个层，称为**全连接层(fully connected layer)**。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/eMMoZ1O.png" width="80%">
</div>

我们还可以通过一张图来表示神经网络：每个神经元对应层输入/输出层的一个节点，神经元之间的连接则构成了图的边。同时不难发现，基本的线性分类器等价于将输入层和输出层直接相连的神经网络，当然还需要去除掉输出层的激活函数。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/tBssqP0.png" width="80%">
</div>

如果把更多的层组合到一起就得到了通常意义下的"神经网络"，其中输入层和输出层直接的称为**隐层(hidden layer)**。在大多数情况下统计神经网络的层数都不包含输入层，因此最基本的神经网络模型是仅包含一个隐层的双层神经网络。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/9qsFaya.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/oalCB8z.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/9yUOxDc.png" width="80%">
</div>

对于复杂的模型，我们还需要关注如何前向计算损失函数以及如何计算损失函数对于每一层参数的导数。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/cdbpq9z.png" width="80%">
</div>

为了开发出通用的算法，我们需要把整个模型看做是一张**计算图(computation graph)**。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/HMV1b0m.png" width="80%">
</div>

一些函数的计算图表示如下：

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/eSjWbdS.png" width="40%">
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/SmzDlVE.png" width="43%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/r9YNsd6.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/rxOAwDW.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/KY7B6oF.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/X9IQUFw.png" width="80%">
</div>

得到局部导数后再结合**链式法则(chain rule)**将后一层计算的导数乘以当前层的局部导数就可以得到损失函数关于当前层的导数。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/AloXoaO.png" width="80%">
</div>

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/gD9Wh6x.png" width="80%">
</div>

这样从后向前依次计算就得到了损失函数关于模型每一层的导数。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/N1VW4fN.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/ZqGeoDT.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/JTJQuH6.png" width="80%">
</div>

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/5i8i01w.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/zPhSNqe.png" width="80%">
</div>

在计算导数时在每个节点上将后一层节点传过来的导数以及自身的局部导数相乘即可获得所需的导数。还需要注意的一点是在反向计算时每个节点需要把所有的路径上的导数相加才是输出关于当前节点的导数。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/grEj8gF.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/9Py0QsJ.png" width="80%">
</div>

对于相乘运算，每个参与节点接收到的导数等于相乘后的导数乘以另一个参与节点。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/7YZ8ihx.png" width="80%">
</div>

而对于最大值运算，导数只会传递给取最大值处的节点，其它节点接收到的导数为0。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/pxuSDhW.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/MtLjbGm.png" width="80%">
</div>

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/ZCa3bn2.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/m1DYdnV.png" width="80%">
</div>

对于全连接层，矩阵形式的前向计算非常简单，只需要使用矩阵乘法来代替标量乘法即可。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/DKDM8Fy.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/csxaiqx.png" width="90%">
</div>

除了全连接层之外，非线性激活函数也需要进行向量化。由于激活函数是单独作用在每个元素上的，在进行前向计算时需要进行逐元素的操作。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/uogorRw.png" width="80%">
</div>

类似地，激活函数在反向计算时也需要进行向量化。由于前向计算时是对每个元素单独进行的计算，因此局部的导数矩阵是一个稀疏的对角矩阵。利用这一点同样可以提高反向计算时的效率。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/oskVWQ9.png" width="80%">
</div>
