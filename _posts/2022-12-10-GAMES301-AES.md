...
Hessian矩阵的计算与梯度项是非常类似的，我们同样利用链式法则对Hessian矩阵进行展开：
...
其中$\frac{\partial \mathbf{f}_q}{\partial \mathbf{x}}$已经在[前面](/2022/12/10/GAMES301-AES.html#compute-fracpartial-mathbffpartial-mathbfx)推导过了，因此我们只需要关注能量函数关于变形梯度的二阶项$\frac{\partial^2 \Psi_q}{\partial \mathbf{f}_q^2}$。
