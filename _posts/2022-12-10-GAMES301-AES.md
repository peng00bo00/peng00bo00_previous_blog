...
上式非常不直观，但可以使用符号计算来进行验证。

得到系数后可以求解二次方程$A \alpha^2 + B \alpha + C = 0$，其中较小的那个根即为当前三角形上满足无翻转的更新步长上界。通过对网格上所有三角形进行遍历，所有三角形上步长上界中的最小值即为整个网格更新步长的上界。
...
<img src="https://i.imgur.com/Q17floZ.gif" width="40%">
</div>
