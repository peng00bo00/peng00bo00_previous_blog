...
$$
{II}_\mathbf{C} = \text{det} (\mathbf{C^2}) = \lambda_0^4 + \lambda_1^4 + \lambda_2^4
$$
...
其中$\mathbf{C} = \mathbf{U}^T \mathbf{U}$称为**右Cauchy-Green变形张量(right Cauchy-Green deformation tensor)**。
