...
当我们在向量空间上引入度量函数就得到了**赋范向量空间(normed vector space)**，其度量函数$$d$$一般也被称为范数，记为$$\Vert \cdot \Vert$$。
...
在赋范向量空间的基础上我们还可以进一步定义**内积空间(inner product space)**，其中内积函数$$<, >: V \times V \rightarrow \mathbb{R}$$给出了向量之间的夹角。
