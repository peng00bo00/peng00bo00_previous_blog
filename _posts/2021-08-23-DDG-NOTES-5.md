...
上式说明对于平面曲线，最小化Dirichlet能量等价于最小化曲线长度。
...
从变分的角度来看，求解最小化Dirichlet能量相当于求解给定端点的约束优化问题。利用分部积分可以将Dirichlet能量改写为内积的形式：

$$
\min_\gamma \int_0^1 \vert \gamma'(t) \vert^2 dt \Leftrightarrow \min_\gamma -\int_0^1 \langle \gamma(t), \gamma''(t) \rangle dt
$$

对曲线$\gamma$求偏导并置0，可以得到一维Laplace方程：
...
我们称满足Laplace方程的函数为**调和函数(harmonic functions)**。上面的推导说明测地线为满足边界条件的调和函数。

<div align=center>
<img src="https://i.imgur.com/hUArmXx.png" width="30%">
</div>
