...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/W0B2Pwv.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/Km0Z787.png" width="80%">
</div>

二维网格的计算方法与一维类似，只不过考虑每个格子上下左右四个相邻的格子进行差分。更进一步，我们可以把一阶差分定义在格子的边界上，进而计算每个格子中心处的二阶差分：

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/AostyRv.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/6VmiMHw.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/9iRBicI.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/T8VQ0hK.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/76Er0np.png" width="80%">
</div>

除此之外，staggered grid另一个好处在于每个格子两个方向速度的变化量等于格子内流体体积的变化量。对于不可压缩流体我们需要保证在每个格子上的净流出量为0，即**质量守恒(conservation of mass)**。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/ElJN0k0.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/DHGIFH6.png" width="80%">
</div>

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/z9pW09d.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/TFTzNGl.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/joNEv37.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/dEbfm9P.png" width="80%">
</div>

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/Lo2HCt1.png" width="80%">
</div>

如果时间步长$\Delta t$比较大的话还可以采用逐步倒推的方式将$\Delta t$拆分成若干小步，然后依次向前递推粒子的位置并使用最后一步计算出的速度作为粒子在上一时刻的速度。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/wzmbXBv.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/eCRokAh.png" width="80%">
</div>

要解决这个问题可以采用前面提过的缩减时间步长的方法，将$\Delta t$拆分成若干小步进行积分。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/drxFXv3.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/SHXlyl7.png" width="80%">
</div>

那么如何计算网格上的压强呢？从物理本质上讲压强来自于流体的不可压缩性，因此我们需要使用质量守恒来更新压强：

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/2aaeMmh.png" width="80%">
</div>

整理后可以得到关于压强的方程组。我们只需要结合边界条件求解出压强再更更新速度场即可。

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/izToSRi.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/47IQF8r.png" width="80%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/egd3IHd.png" width="80%">
</div>
