...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/SuWVYEL.png" width="50%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/i.imgur.com/Oej54wY.png" width="50%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/upload.wikimedia.org/wikipedia/commons/8/8b/Polyreg_scheffe.svg" width="50%">
</div>
...
<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/upload.wikimedia.org/wikipedia/commons/4/4b/KfoldCV.gif" width="63%">
</div>

k-fold交叉验证的一种极端情况是取k为训练数据总数，此时每次只在一个数据点上进行验证并需要对整个数据集进行遍历。称这种交叉验证方法为**留一法(leave-one-out cross-validation)**：

<div align=center>
<img src="https://pic1.xuehuaimg.com/proxy/upload.wikimedia.org/wikipedia/commons/c/c7/LOOCV.gif" width="50%">
</div>
