...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/ZOer74o.png" width="60%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/ZpYW7Oh.png" width="30%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/az7L7iY.png" width="70%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/nvhk9eG.png" width="50%">
</div>

另一种常见的反射类型是**镜面反射(surface reflection)**，此时反射会集中到某些指定的方向使得物体表面出现反光的效果。

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/PNfmEhs.png" width="50%">
</div>

当然大多数情况下物体表面会同时发生漫反射和镜面反射。

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/YvrBSi4.png" width="52%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/SFRrA3O.png" width="60%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/9G7olsF.png" width="67%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/qqB029q.png" width="50%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/I0a6Vlo.png" width="30%">
<img src="https://images.weserv.nl/?url=i.imgur.com/QGAiVSi.png" width="30%">
</div>

类似地，图像的空间感也会干扰人眼对颜色的认知。

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/NhNL6oN.png" width="50%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/uNIsSqc.png" width="50%">
</div>

那么对于具有不同反照率的平面物体在变化的光源下会得到类似于下面的图像：

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/g0AE3LE.png" width="70%">
</div>

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/eusF6q4.png" width="50%">
</div>

如果假定光照是缓慢变化的，那么我们可以从照射得到的图像上恢复物体的反照率。具体而言需要只对图像取对数并计算导数：

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/DzEtWNP.png" width="50%">
</div>

由于光照是缓慢变化的，在取对数后光照对应导数中非常小的部分，我们可以使用阈值化来过滤掉它。这样我们对过滤后的函数进行积分就能够重建出物体的albedo(和真实值只相差一个常数)。

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/PyEj30h.png" width="60%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/21ftIF2.png" width="50%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/AMS0xIk.png" width="50%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/R0VwyQQ.png" width="60%">
</div>

因此对于平面图像上的任意一点我们可以取出该点的像素值并在gradient space绘制出对应的曲线，该点在曲面上的法向一定位于这条曲线上。尽管如此，我们还是无法确定法向的具体方向。

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/4e0Kl7w.png" width="60%">
</div>
...
<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/ujRHsB8.png" width="37%">
<img src="https://images.weserv.nl/?url=i.imgur.com/FdKsPgK.png" width="15%">
<img src="https://images.weserv.nl/?url=i.imgur.com/eoV5j1W.png" width="15%">
<img src="https://images.weserv.nl/?url=i.imgur.com/bahr9yZ.png" width="15%">
</div>

光度立体的本质是在gradient space上求曲线交点。对于每个给定的光源，我们都可以在gradient space上画出相应的曲线，且待求的法向一定位于这些曲线的交点上。由于每条曲线都是二次曲线，我们至少需要3条曲线才能确定这个交点。

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/L2zTZgL.png" width="50%">
</div>

利用光度立体的方法我们可以重建曲面的法线并对曲面的albedo进行估计，如下图所示。

<div align=center>
<img src="https://images.weserv.nl/?url=i.imgur.com/3ni3ROf.png" width="70%">
</div>
